    ...
    <section id="gallery" className="py-12 sm:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 relative z-10">
        ...
        <div className="text-center mt-12 md:mt-20 animate-fade-in-up">
          <div className="flex flex-col md:inline-flex md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6 bg-pearl-white/90 px-6 md:px-12 py-6 md:py-8 border border-dusty-mauve/30 rounded-2xl mx-4 md:mx-0 shadow-elegant">
            <svg className="w-6 h-6 md:w-8 md:h-8 text-deep-burgundy flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center md:text-left">
              ...
              <span className="font-playfair text-deep-burgundy font-medium text-base md:text-lg block md:inline md:ml-2">
